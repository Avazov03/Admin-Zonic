...
export class MarketItemDto {
  ...
  @ApiProperty({
    nullable: true,
    required: false,
    example: 'https://admin.zonic.uz/api/Admin/Image?fileId=....png',
    description: 'Absolute URL for shop preview (use this in mobile instead of local hardcode)',
  })
  ...
  @ApiProperty({
    nullable: true,
    required: false,
    example: 'https://admin.zonic.uz/frames/frame_ice.png',
    description: 'Stable public asset by code — preferred for frame overlays',
  })
